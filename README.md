...
Each of the 120 NZEBs from which we received the data of 
...
This is due to the fact the total amount of electricity that enters the NZEB is the sum
of what is generated by the solar panels (Solar_out) and what comes from the net (Smart_in). 
